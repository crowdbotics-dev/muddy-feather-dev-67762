"""
Django settings for muddy_feather_dev_67762 project.
...
ROOT_URLCONF = 'muddy_feather_dev_67762.urls'
...
WSGI_APPLICATION = 'muddy_feather_dev_67762.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_feather_dev_67762 API",
    "DESCRIPTION": "API documentation for muddy_feather_dev_67762 App",
    "VERSION": "v1",
}
